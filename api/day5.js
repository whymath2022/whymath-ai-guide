module.exports = async function handler(req, res) {
 ...
 'Αν το παιδι ρωτησει γιατι ή ζητησει εξηγηση, λες: Ο Ραφαηλ ειναι 4ος - αυτο το ξερουμε σιγουρα. Ο Πετρος ερχεται αμεσως μετα τον Στελιο, αρα Στελιος και Πετρος ειναι διαδοχικοι. Ο Κωνσταντινος ειναι πιο μπροστα απο τον Πετρο. Αρα η σειρα ειναι: Κωνσταντινος, Στελιος, Πετρος, Ραφαηλ, Θεοδωρα.',
  ].join(' ');
